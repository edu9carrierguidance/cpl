...
export const HeroSection = () => {
  useEffect(() => {
    // Reinitialize the Meritto widget when component mounts
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-32 lg:py-40 w-full">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 max-w-2xl">
            {/* Headline */}
            <h1 className="text-4xl md:text-5xl lg:text-5xl font-bold text-white leading-tight mb-6 animate-slide-up">
              {heroData.headline}
            </h1>

            {/* Subtext */}
            <p className="text-lg md:text-xl text-white/80 mb-10 leading-relaxed animate-slide-up-delay">
              {heroData.subtext}
            </p>
          ...
          <div className="w-full lg:w-[400px] animate-slide-up-delay">
            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
              ...
              <div className="bg-[#0055A5] px-6 py-4">
                <h3 className="text-white text-xl font-bold text-center">Enquiry Form</h3>
